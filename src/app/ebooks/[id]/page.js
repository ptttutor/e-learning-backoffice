      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <nav style={{ fontSize: '14px', color: '#6c757d' }}>
            <Link href="/ebooks" style={{ color: '#007bff', textDecoration: 'none' }}>
              eBooks
            </Link>
            {ebook.category && (
              <>
            ...
            <div style={{
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  {ebook.pageCount && (
                    <div>
                      <strong>จำนวนหน้า:</strong><br />
                      <span style={{ color: '#6c757d' }}>{ebook.pageCount} หน้า</span>
                    </div>
                  )}
                  <div>
                    <strong>ภาษา:</strong><br />
                    ...
                    <>
                      {ebook.weight && (
                        <div>
                          ...
                          <span style={{ color: '#6c757d' }}>{ebook.weight} kg</span>
                        </div>
                      )}
                      {ebook.dimensions && (
                        <div>
                          <strong>ขนาด:</strong><br />
                          <span style={{ color: '#6c757d' }}>{ebook.dimensions}</span>
                        </div>
                      )}
                    </>
                  )}
                ...
                {ebook.averageRating > 0 && (
                  <div style={{ 
                    ...
                    <span style={{ fontSize: '16px', color: '#6c757d' }}>
                      {ebook.averageRating.toFixed(1)} ({ebook._count.reviews} รีวิว)
                    </span>
                  </div>
                )}
              </div>
