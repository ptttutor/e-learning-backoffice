...
import { Card, Tabs, Row, Col, Statistic, Switch, Space, Typography, Avatar, Divider, Badge } from 'antd';
import {
  DashboardOutlined,
  BookOutlined,
  DollarOutlined,
        ...
        <Row align="middle" justify="space-between">
          <Col>
            <Space align="start">
              ...
              <div>
                <Title level={1} style={{ margin: 0, color: '#fff', fontWeight: '300' }}>
                  Dashboard
                </Title>
          ...
          <Card 
            title={
              <Space>
                ...
                <span style={{ fontSize: '18px', fontWeight: '600' }}>สถิติโดยรวม</span>
              </Space>
            }
            style={{ 
              marginBottom: '24px',
          ...
          >
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '12px' }}>รายได้รวม</span>}
                    value={stats.stats.revenue.total}
                    prefix={<DollarOutlined style={{ color: '#fff', fontSize: '16px' }} />}
                    suffix="บาท"
              ...
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '12px' }}>คำสั่งซื้อทั้งหมด</span>}
                    value={stats.stats.orders.total}
                    prefix={<ShoppingCartOutlined style={{ color: '#fff', fontSize: '16px' }} />}
                    valueStyle={{ color: '#fff', fontSize: '18px', fontWeight: 'bold' }}
                  />
                  <div style={{ marginTop: '6px', fontSize: '10px' }}>
                    <Badge status="success" />
                    <span style={{ color: 'rgba(255,255,255,0.9)' }}>สำเร็จ: {stats.stats.orders.completed}</span>
                    <br />
                    <Badge status="processing" />
                    <span style={{ color: 'rgba(255,255,255,0.9)' }}>รออนุมัติ: {stats.stats.orders.pending}</span>
                  </div>
                </Card>
              </Col>
              ...
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '12px' }}>ผู้ใช้ใหม่</span>}
                    value={stats.stats.users.new}
                    prefix={<UserOutlined style={{ color: '#fff', fontSize: '16px' }} />}
                    valueStyle={{ color: '#fff', fontSize: '18px', fontWeight: 'bold' }}
                  />
                  <div style={{ marginTop: '6px', fontSize: '10px', color: 'rgba(255,255,255,0.8)' }}>
              ...
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '12px' }}>Course ทั้งหมด</span>}
                    value={stats.stats.courses.total}
                    prefix={<BookOutlined style={{ color: '#fff', fontSize: '16px' }} />}
                    valueStyle={{ color: '#fff', fontSize: '18px', fontWeight: 'bold' }}
                  />
                  <div style={{ marginTop: '6px', fontSize: '10px', color: 'rgba(255,255,255,0.8)' }}>
              ...
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '12px' }}>E-book ทั้งหมด</span>}
              ...
              <Col xs={24} sm={12} md={8} lg={4}>
                ...
                >
                  <Statistic
                    title={<span style={{ color: 'rgba(255,255,255,0.9)' }}>การลงทะเบียนใหม่</span>}
                    value={stats.stats.enrollments.total}
                    valueStyle={{ color: '#fff', fontSize: '20px', fontWeight: 'bold' }}
                  />
                  <div style={{ marginTop: 8, fontSize: '12px', color: 'rgba(255,255,255,0.8)' }}>
